...
function run_minecraft_server() {
  ...
  /usr/bin/java -XX:+UnlockExperimentalVMOptions \
    -Dcom.sun.management.jmxremote.port=9999 -Dcom.sun.management.jmxremote.rmi.port=9999 -Djava.rmi.server.hostname=127.0.0.1 -Dcom.sun.management.jmxremote.authenticate=false \
