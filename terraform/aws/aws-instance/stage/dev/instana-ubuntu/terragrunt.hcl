...
inputs = {
  ...
  ec2_ami_name_query    = "ubuntu/images/hvm-ssd-*/ubuntu-resolute-26.04-*-server-*"
  ec2_ami_account_alias = "amazon"
  user_data_template    = local.user_data_template
  user_data_vars        = [get_env("INSTANA_AGENT_TOKEN", ""), get_env("INSTANA_AGENT_BACKEND", "ingress-green-saas.instana.io:443"), get_env("INSTANA_OTEL_BACKEND", "https://otlp-green-saas.instana.io:4317")]
  aws_tags = {
    Env    = "dev"
    Region = "us-east1"
    Module = "aws-instance"
