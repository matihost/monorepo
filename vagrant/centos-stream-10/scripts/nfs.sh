...
# echo 'share3 -fstype=nfs,rw 172.30.250.4:/mnt/storage/share3' > /etc/auto.vm-nfs

# or wildcard mount of all exported subdirs of /mtn/storage to /mnt/nas/vm/*
# echo '* -fstype=nfs,rw 172.30.250.4:/mnt/storage/&' > /etc/auto.vm-nfs

# or direct mount
# mkdir -p /mnt/nas/vm
# echo '/- /etc/auto.vm-nfs' > /etc/auto.master.d/vm-nfs.autofs
# echo '/mnt/nas/vm/share3 -fstype=nfs,rw 172.30.250.4:/mnt/storage/share3' > /etc/auto.vm-nfs
