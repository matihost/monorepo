...
echo "172.30.250.4 magic.centos magic super.centos super" >>/etc/hosts

# configure eth2 as it is set manual via VBox networking
nmcli c add con-name eth2 ifname eth2 type ethernet ipv4.method manual ipv4.addresses 172.30.250.4/24 ipv4.dns 10.0.2.3 connection.autoconnect yes ipv6.addr-gen-mode eui64
